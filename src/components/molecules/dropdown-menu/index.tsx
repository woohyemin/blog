...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[120px] overflow-hidden rounded-xl border border-divider bg-background p-2 text-secondary shadow-md",
        className
      )}
      {...props}
    />
...
>(({ className, children, checked, ...props }, ref) => (
  ...
  >
    <Check
      className={`h-3.5 w-3.5 absolute left-2 flex items-center justify-center ${
        checked ? "text-primary" : "text-placeholder"
      }`}
      strokeWidth={3}
    />
    {children}
