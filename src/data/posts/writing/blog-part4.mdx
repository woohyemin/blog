---
title: "[나만의 블로그를 만들어보자 4편] Github 연동하기"
date: "2024-08-12 23:00:00"
description: "나만의 블로그 프로젝트를 Github에 연동해보자"
series: "blog"
categories: ["Blog", "Github"]
thumbnail: "blog/part4/blog_part4_thumbnail.jpg"
tags: ["Blog", "Github"]
activate: true
---

사실 개인 프로젝트이기 때문에 원격 저장소 연동이 필수는 아니라고 생각한다.<Emoji>🤔</Emoji>
...
아래 명령어를 입력하여 Github 연동을 완료할 수 있었다.
